            ...
            <span>{userProfile.nickname}</span>님, 오늘도 반가워요!
              <div className="profile_card">
                <div className="profile_item">
                  <h3>저속노화 레벨</h3>
                  <p className="profile_value">LEVEL <span>{userProfile.level}</span></p>
                </div>
                <div className="profile_item">
                  <h3>기록 배지</h3>
        ...
        <section className='features_section'>
          ...
          <div className='features'>
            <div className='feature'>
              ...
              <p><span className='font_light1'>저속노화를 향한 일상 속 루틴 만들기</span></p>
              <p2>저속노화 습관 발걸음</p2>
            </div>
            ...
            <div className='feature'>
              ...
              <p><span className='font_light1'>한 달 동안의 발걸음 한 눈에 보기</span></p>
              <p2>월간 통계</p2>
            </div>
          </div>
        </section>
